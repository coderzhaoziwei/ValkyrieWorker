/** 聊天类
 * @param {string} channel - 聊天频道
 * @param {string} content - 聊天内容
 * @param {string} id      - 发言者的标识
 * @param {string} name    - 发言者的名称
 * @param {date}   time    - 本地生成的时间
 *
 * @param {number} level   - 世界频道专有：等级
 * @param {string} family  - 门派频道专有：门派
 * @param {string} server  - 全区频道专有：服务器
 */
